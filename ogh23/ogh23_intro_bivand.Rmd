...
```{r, echo=FALSE}
cl <- read.csv("../watchlist_output/count_series.csv")
plot(watchlist_length ~ I(as.Date(date)), cl, ylim=c(0, 225), xlim=as.Date(c("2023-06-01", "2023-10-31")), xlab="", ylab="remaining vulnerable packages")
grid()
```
